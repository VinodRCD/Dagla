...
public class HorizontalDottedProgress extends View {
    ...
    //Bounced Dot Radius
    private int mBounceDotRadius = 20;
    ...
    private void createDot(Canvas canvas, Paint paint) {
        ...
        for(int i = 0; i < mDotAmount; i++ ){
            if(i == mDotPosition){
                canvas.drawCircle(50+(i*50), mBounceDotRadius, mBounceDotRadius, paint);
            }else {
                canvas.drawCircle(50+(i*50), mBounceDotRadius, mDotRadius, paint);
            }
        }
