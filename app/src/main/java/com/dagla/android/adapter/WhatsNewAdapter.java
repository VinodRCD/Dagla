...
public class WhatsNewAdapter extends PagerAdapter {
    ...
    public WhatsNewAdapter(Context context, ArrayList<HashMap<String, String>> arrayList1, ArrayList<HashMap<String, String>> arrayList2, ArrayList<HashMap<String, String>> arrayList3,
             ArrayList<HashMap<String, String>> arrayList4) {
