...
public class ImagesAdapter extends PagerAdapter {
    ...
    ProductDescriptionFragment fragment;


    public ImagesAdapter(Context context, ArrayList<String> arrImages, ProductDescriptionFragment fragment) {
...
//        inflater = LayoutInflater.from(context);
    ...
    public Object instantiateItem(ViewGroup view, final int position) {
        ...
        String lang = GlobalFunctions.getLang(mContext);
...
//        Log.v("Images",arrImages.get(position));
    ...
    public void showGallery(int position) {
        ...
        Adapter_Gallery adapter_gallery = new Adapter_Gallery(mContext, arrImages);
