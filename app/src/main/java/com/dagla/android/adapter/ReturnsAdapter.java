...
public class ReturnsAdapter extends ArrayAdapter<String> {
    ...
    public ReturnsAdapter(Activity context, ArrayList<String> names) {
...
//            holder.lblStatus.setTypeface(custom_fontmedium);
            ...
            holder.lblOrderID.setText(obj.getString("order_id"));
            holder.lblPrice.setText(obj.getString("price"));
            holder.lblDate.setText(obj.getString("date"));
            holder.lblItemsCount.setText(obj.getString("item_name"));
