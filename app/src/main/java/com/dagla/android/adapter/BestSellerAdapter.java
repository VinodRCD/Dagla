...
public class BestSellerAdapter extends PagerAdapter {
    ...
    public BestSellerAdapter(Context context, ArrayList<HashMap<String, String>> arrayList1, ArrayList<HashMap<String, String>> arrayList2, ArrayList<HashMap<String, String>> arrayList3,
                             ArrayList<HashMap<String, String>> arrayList4) {
