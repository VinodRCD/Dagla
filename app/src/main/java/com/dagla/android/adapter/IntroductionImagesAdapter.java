...
public class IntroductionImagesAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        if(GlobalFunctions.getLang(context).equals("ar")){
            rowView = inflater.inflate(R.layout.introduction_pager_layout_ar, view, false);
        }else {
            rowView = inflater.inflate(R.layout.introduction_pager_layout, view, false);
        }
...
//                .into(img);
        ...
        ImageLoader.getInstance().displayImage(String.valueOf(arrImages.get(position)), img, options, new ImageLoadingListener() {
            ...
            public void onLoadingStarted(String imageUri, View view) {
                ((IntroductionActivity)context).showLoading();
            }
            @Override
            ...
            public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
                ...
                ((IntroductionActivity)context).hideLoading();
