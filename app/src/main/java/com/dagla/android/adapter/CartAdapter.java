...
import com.dagla.android.fragments.CartFragment;
...
public class CartAdapter extends ArrayAdapter<String> {
    ...
    public CartAdapter(Activity context, ArrayList<String> names,CartFragment fragment) {
    ...
    public CartAdapter(Activity context, ArrayList<String> names, CartFragmentNew fragment2) {
        super(context, R.layout.layout_cart, names);
        this.context = context;
        this.names = names;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            if(GlobalFunctions.getLang(context).equals("ar")){
                rowView = inflater.inflate(R.layout.layout_cart_ar, null);
            }else {
...
//            holder.lblQty.setTypeface(custom_fontnormal);
            ...
            holder.btnMinus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    fragment.quantityMinus(position);
            ...
            holder.btnPlus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    fragment.quantityPlus(position);
