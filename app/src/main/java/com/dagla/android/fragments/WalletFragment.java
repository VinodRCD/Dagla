...
import com.dagla.android.adapter.WalletAdapter;
...
public class WalletFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(GlobalFunctions.getLang(getActivity()).equals("ar")){
            ((MainActivity) getActivity()).setHeaders(getResources().getString(R.string.wallet_ar),false,false,false,true, false ,"0", false);
        }else {
            ((MainActivity) getActivity()).setHeaders(getResources().getString(R.string.wallet),false,false,false,true, false ,"0", false);
        }


        if (rootView == null) {
            if(GlobalFunctions.getLang(getActivity()).equals("ar")){
                rootView = inflater.inflate(R.layout.fragment_wallet_ar, container, false);
            }else {
            ...
            lblTotalTxt = (TextView) rootView.findViewById(R.id.lblTotalTxt);
...
//                        OrderReceiptFragment fragment = new OrderReceiptFragment();
    ...
    private void loadData() {
        ...
        if (GlobalFunctions.hasConnection(getActivity())) {
            ...
            client.get(GlobalFunctions.serviceURL + "getMyWallet", params, new AsyncHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, byte[] bytes) {
                    ...
                    try {
                        ...
                        //
                        if (obj.getString("wallet_status").equalsIgnoreCase("Active")) {
                            //
                            ...
                            //
                            arrAdapter = new WalletAdapter(getActivity(), arrList);
                            //
                            lv.setAdapter(arrAdapter);

                            lblTotal.setText(obj.getString("wallet_balance"));
...
//                                if (arrList.size() == 1) {
//                                    if(GlobalFunctions.getLang(getActivity()).equals("ar")){
//                                        lblTotal.setText("1   "+getString(R.string.order_ar));
//                                    }else {
...
//                                } else {
//                                    if(GlobalFunctions.getLang(getActivity()).equals("ar")){
//                                        lblTotal.setText(""+arrList.size()+"   "+ getString(R.string.orders_ar));
//                                    }else {
