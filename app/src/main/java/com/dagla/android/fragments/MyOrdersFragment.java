...
public class MyOrdersFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(GlobalFunctions.getLang(getActivity()).equals("ar")){
            ((MainActivity) getActivity()).setHeaders(getResources().getString(R.string.my_orders_ar),false,false,false,true, false ,"0", false);
        }else {
            ((MainActivity) getActivity()).setHeaders(getResources().getString(R.string.my_orders),false,false,false,true, false ,"0", false);
        }


        if (rootView == null) {
            if(GlobalFunctions.getLang(getActivity()).equals("ar")){
                rootView = inflater.inflate(R.layout.fragments_my_orders_ar, container, false);
            }else {
                rootView = inflater.inflate(R.layout.fragments_my_orders, container, false);
            }
                ...
                public void onSuccess(int statusCode, Header[] headers, byte[] bytes) {
                    ...
                    try {
                        ...
                        if (obj.getString("status").equalsIgnoreCase("1")) {
                            ...
                            //
                            arrAdapter = new OrdersAdapter(getActivity(), arrList);
                            //
